...
<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>User feedback Information</title>
...
<body>
 <header id="header" id="home">
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<span class="lnr lnr-arrow-right"></span>  <a href="user_feedback.php">User Feedback Information </a></p>
						</div>	
					</div>
				</div>
			</section>
		...
		<div  class="container">
			...
			<form  method="POST" action="user_feedback_view.php">
			
			<p align="right" ><a href='user_feedback_Pdf.php'>
			<img border="0" alt="pdf" src="img/pdf.png" width="50" height="50">
			</a>
			</p>
				<h2>User Feedback information </h2><hr>
			<?php
				...
				echo '
					<h4>Batch No  :</h4>
						'.$row['batch_no'].'	
					<h4> Sending Sample to user Date :</h4>
						'.$row['sending_date'].'			
						
					<h4>Feedback Date from user  :</h4>
						'.$row['feedback_date'].'
            <h4> Rating for Product:</h4>
						'.$row['rating'].'			
						
					<h4>Feedback Message from user  :</h4>
						'.$row['message'].'						
						
						<br><br>
						<a href="user_feedback_edit.php?edit='.$row['id'].'">Edit</a> 
						<a href="user_feedback_delete.php?delete='.$row['id'].'">Delete</a>
<hr>
					';
