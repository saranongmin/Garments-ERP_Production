...
<body>
 <header id="header" id="home">
		...
		<div  class="container">
			...
			<form  method="POST" action="fabric_info_view.php">
			
			<p align="right" ><a href='fabric_pdf.php'>
			<img border="0" alt="pdf" src="img/pdf.png" width="50" height="50">
			</a>
			</p>
				<h2>Fabric information </h2><hr>
			<?php
				...
				echo '
					...
					<h4>Preparation Date  :</h4>
						...
						<br><br>
						<a href="fabric_info_edit.php?edit='.$row['id'].'">Edit</a> 
						<a href="fabric_info_delete.php?delete='.$row['id'].'">Delete</a>
<hr>
					';
