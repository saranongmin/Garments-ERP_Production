<?php 
	...
	if (isset($_GET['edit'])) {
		...
		$sql=mysqli_query($db,"SELECT * FROM fabric_info WHERE id='".$id."' ");
	...
	$sql="UPDATE fabric_info SET batch_no='".$no."',prepared_date='".$date."' where id='".$id."'";
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<span class="lnr lnr-arrow-right"></span>  <a href="fabric_info.php">Fabric Information </a></p>
						</div>	
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-lg-4 col-md-12 home-about-right relative">
							<form class="form-wrap" method ="POST" action="fabric_info_edit.php">
								<h4 class="text-white pb-20"><center>Fabric Information</center></h4>
								<input type="hidden" name="id" value="<?php echo $id ?>" >
								<input type="text" class="form-control" placeholder="Batch No" name="batch_no" value="<?php echo $no ?>">
								
								<input type="text" class="form-control" placeholder="Fabric Prepared Date" name="prepared_date" value="<?php echo $date ?>" >
