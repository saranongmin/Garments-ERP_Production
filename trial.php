<?php 
	...
	if (isset($_GET['edit'])) {
		...
		$sql=mysqli_query($db,"SELECT * FROM garments_info WHERE id='".$id."' ");
			...
			if ($row=$sql->fetch_assoc()) {
				...
				$no = $row['batch_no'];
				$Taken_Date_Fabric = $row['taken_date_fabric'];
	...
	$sql="UPDATE garments_info SET batch_no='".$no."',taken_date_fabric='".$Taken_Date_Fabric."',
				...
				<div class="container">
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-lg-4 col-md-12 home-about-right relative">
							<form class="form-wrap" method ="POST" action="Garments_info_view.php">
								...
								<input type="text" class="form-control" name ="taken_date_fabric" placeholder="Taken Date from Fabric:" value="<?php echo $Taken_Date_Fabric ?>">
								<input type="text" class="form-control" name ="prepared_Date"  placeholder="Prepared Date:" value="<?php echo $date ?>">
