 ...
 <?php 
	 ...
	 if (isset($_POST['insert']))
          ...
          $date = $_POST['prepared_date']; 
			...
			$sql = "INSERT INTO fabric_info (batch_no, prepared_date)
                      VALUES ('$no', '$date')";
		...
		if(mysqli_query($db, $sql)){
			...
			header("refresh:3; url=fabric_info.php");
				...
				<div class="container">
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-lg-4 col-md-12 home-about-right relative">
							<form class="form-wrap" method ="post" action="fabric_info.php">
								...
								<input type="text" class="form-control" placeholder="Fabric Prepared Date" name="prepared_date"><br>
								
								
                                  <button type="submit" name="insert" class="primary-btn">Insert</button>
								  	<p align="right" ><a href='fabric_info_view.php'>
