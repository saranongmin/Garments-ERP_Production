<?php 
	...
	if (isset($_GET['edit'])) {
		...
		$sql=mysqli_query($db,"SELECT * FROM user_feedback WHERE id='".$id."' ");
	...
	$sql="UPDATE user_feedback SET batch_no ='".$no."',sending_date='".$Sending_date."',
	feedback_date='".$Feedback_date."',rating='".$Rating."',
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<span class="lnr lnr-arrow-right"></span>  <a href="user_feedback.php">User Feedback </a></p>
						</div>	
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-lg-4 col-md-12 home-about-right relative">
							<form class="form-wrap" method ="post" action="user_feedback_edit.php">
								<h4 class="text-white pb-20"><center>User Feedback</center></h4>
								<input type="hidden" name="id" value="<?php echo $id ?>" >
									<input type="text" class="form-control" placeholder="Batch No" name="batch_no" value="<?php echo $no ?>">
								<input type="text" class="form-control" name ="sending_date" placeholder="Sending Sample to user Date :" value="<?php echo $Sending_date ?>">
								<input type="text" class="form-control" name ="feedback_date"placeholder="Feedback Date from user:" value="<?php echo $Feedback_date ?>">
								<input type="number" class="form-control"name ="rating" placeholder="Enter Rating for Product:" value="<?php echo $Rating ?>">
								<input type="text" class="form-control"  name="message" cols="30" rows="10"   placeholder="Details" value="<?php echo $Message ?>">
