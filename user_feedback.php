	 ...
	 if (isset($_POST['insert']))
		 ...
		 $no = $_POST['batch_no'];
          ...
          $Message = $_POST['message']; 
			...
			$sql = "INSERT INTO user_feedback (batch_no,sending_date, feedback_date,rating,message)
                      VALUES ('$no','$Sending_date', '$Feedback_date','$Rating','$Message')";
	 
	 
		if(mysqli_query($db, $sql)){

			echo '<script type="text/javascript">alert("Records inserted successfully.")</script>';
			header("refresh:3; url=user_feedback.php");
				...
				<div class="container">
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-lg-4 col-md-12 home-about-right relative">
							<form class="form-wrap" method ="post" action="user_feedback.php">
								...
								<input type="text" class="form-control" name ="sending_date" placeholder="Sending Sample to user Date :">
								<input type="text" class="form-control" name ="feedback_date"placeholder="Feedback Date from user:">
								<input type="number" class="form-control"name ="rating" placeholder="Enter Rating for Product:">
								<textarea name="message" id="" cols="30" rows="5" name="message" placeholder="Details" class="form-control"></textarea>
								
							<button type="submit" name="insert" class="primary-btn">Insert</button>
								  	<p align="right" ><a href='user_feedback_view.php'>
