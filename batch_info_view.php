...
<body>
 <header id="header" id="home">
		...
		<div  class="container">
			...
			<form  method="POST" action="batch_info_view.php">
			
			<p align="right" ><a href='batc_pdf.php'>
			<img border="0" alt="pdf" src="img/pdf.png" width="50" height="50">
			</a>
			</p>
				<h2>Batch information </h2><hr>
			<?php
				...
				echo '
					...
					<h4>Taken Date from Merchandising  :</h4>
						'.$row['merch_taken_date'].'			
						
					<h4>Deadline Date  :</h4>
						'.$row['deadline_date'].'
						<br><br>
						<a href="batch_info_edit.php?edit='.$row['id'].'">Edit</a> 
						<a href="batch_info_delete.php?delete='.$row['id'].'">Delete</a>
<hr>
					';
